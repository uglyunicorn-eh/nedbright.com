...
import { GridPattern } from "src/components";
...
export const BookDetailsHead = ({ book }: ComponentProps) => {
  return (
      ...
      <div className="mx-auto grid max-w-6xl grid-cols-1 grid-rows-[auto_1fr] gap-y-16 pt-16 md:pt-20 lg:grid-cols-12 lg:gap-y-20 lg:px-3 lg:pb-16 lg:pt-20">
        <div className="relative flex items-start lg:col-span-5 lg:row-span-2">
          ...
          <div className="relative z-10 mx-auto flex w-64 rounded-xl shadow-2xl shadow-black/15 md:w-80 lg:w-96 aspect-[3/4]">
            <Image className="w-full object-cover rounded-xl" src={book.data.image} alt={book.data.title} />
          </div>
